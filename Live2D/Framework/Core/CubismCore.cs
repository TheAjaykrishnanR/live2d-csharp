...
{
	const string Live2DCubismCoreDll = @"C:\Users\Jayakuttan\dev\csharp-live2d\Live2D\native\Live2DCubismCore.dll";
	//VERSION
	...
	[LibraryImport(Live2DCubismCoreDll, EntryPoint = "csmGetVersion")]
	...
	[LibraryImport(Live2DCubismCoreDll, EntryPoint = "csmGetLatestMocVersion")]
	...
	[LibraryImport(Live2DCubismCoreDll, EntryPoint = "csmGetMocVersion")]
	...
	[LibraryImport(Live2DCubismCoreDll, EntryPoint = "csmHasMocConsistency")]
	...
	[LibraryImport(Live2DCubismCoreDll, EntryPoint = "csmGetLogFunction")]
	...
	[LibraryImport(Live2DCubismCoreDll, EntryPoint = "csmSetLogFunction")]
	...
	[LibraryImport(Live2DCubismCoreDll, EntryPoint = "csmReviveMocInPlace")]
	...
	[LibraryImport(Live2DCubismCoreDll, EntryPoint = "csmGetSizeofModel")]
	...
	/// <returns>Valid pointer on success; '0' otherwise.</returns>
	[LibraryImport(Live2DCubismCoreDll, EntryPoint = "csmInitializeModelInPlace")]
	...
	[LibraryImport(Live2DCubismCoreDll, EntryPoint = "csmUpdateModel")]
...
#pragma warning restore SYSLIB1054 // 使用 “LibraryImportAttribute” 而不是 “DllImportAttribute” 在编译时生成 P/Invoke 封送代码
	...
	[LibraryImport(Live2DCubismCoreDll, EntryPoint = "csmGetParameterCount")]
	...
	/// <param name="model">Model to query.</param>
	/// <returns>Valid pointer on success; '0' otherwise.</returns>
	[LibraryImport(Live2DCubismCoreDll, EntryPoint = "csmGetParameterIds")]
	...
	/// <param name="model">Model to query.</param>
	/// <returns>Valid pointer on success; '0' otherwise.</returns>
	[LibraryImport(Live2DCubismCoreDll, EntryPoint = "csmGetParameterTypes")]
	...
	/// <param name="model">Model to query.</param>
	/// <returns>Valid pointer on success; '0' otherwise.</returns>
	[LibraryImport(Live2DCubismCoreDll, EntryPoint = "csmGetParameterMinimumValues")]
	...
	/// <param name="model">Model to query.</param>
	/// <returns>Valid pointer on success; '0' otherwise.</returns>
	[LibraryImport(Live2DCubismCoreDll, EntryPoint = "csmGetParameterMaximumValues")]
	...
	/// <param name="model">Model to query.</param>
	/// <returns>Valid pointer on success; '0' otherwise.</returns>
	[LibraryImport(Live2DCubismCoreDll, EntryPoint = "csmGetParameterDefaultValues")]
	...
	/// <param name="model">Model to query.</param>
	/// <returns>Valid pointer on success; '0' otherwise.</returns>
	[LibraryImport(Live2DCubismCoreDll, EntryPoint = "csmGetParameterValues")]
	...
	/// <param name="model">Model to query.</param>
	/// <returns>Valid pointer on success; '0' otherwise.</returns>
	[LibraryImport(Live2DCubismCoreDll, EntryPoint = "csmGetParameterKeyCounts")]
	...
	/// <param name="model">Model to query.</param>
	/// <returns>Valid pointer on success; '0' otherwise.</returns>
	[LibraryImport(Live2DCubismCoreDll, EntryPoint = "csmGetParameterKeyValues")]
	...
	/// <param name="model">Model to query.</param>
	/// <returns>Valid count on success; '-1' otherwise.</returns>
	[LibraryImport(Live2DCubismCoreDll, EntryPoint = "csmGetPartCount")]
	...
	/// <param name="model">Model to query.</param>
	/// <returns>Valid pointer on success; '0' otherwise.</returns>
	[LibraryImport(Live2DCubismCoreDll, EntryPoint = "csmGetPartIds")]
	...
	/// <param name="model">Model to query.</param>
	/// <returns>Valid pointer on success; '0' otherwise.</returns>
	[LibraryImport(Live2DCubismCoreDll, EntryPoint = "csmGetPartOpacities")]
	...
	/// <param name="model">Model to query.</param>
	/// <returns>Valid pointer on success; '0' otherwise.</returns>
	[LibraryImport(Live2DCubismCoreDll, EntryPoint = "csmGetPartParentPartIndices")]
	...
	/// <param name="model">Model to query.</param>
	/// <returns>Valid count on success; '-1' otherwise.</returns>
	[LibraryImport(Live2DCubismCoreDll, EntryPoint = "csmGetDrawableCount")]
	...
	/// <param name="model">Model to query.</param>
	/// <returns>Valid pointer on success; '0' otherwise.</returns>
	[LibraryImport(Live2DCubismCoreDll, EntryPoint = "csmGetDrawableIds")]
	...
	/// <param name="model">Model to query.</param>
	/// <returns>Valid pointer on success; '0' otherwise.</returns>
	[LibraryImport(Live2DCubismCoreDll, EntryPoint = "csmGetDrawableConstantFlags")]
	...
	/// <param name="model">Model to query.</param>
	/// <returns>Valid pointer on success; '0' otherwise.</returns>
	[LibraryImport(Live2DCubismCoreDll, EntryPoint = "csmGetDrawableDynamicFlags")]
	...
	/// <param name="model">Model to query.</param>
	/// <returns>Valid pointer on success; '0' otherwise.</returns>
	[LibraryImport(Live2DCubismCoreDll, EntryPoint = "csmGetDrawableTextureIndices")]
	...
	/// <param name="model">Model to query.</param>
	/// <returns>Valid pointer on success; '0' otherwise.</returns>
	[LibraryImport(Live2DCubismCoreDll, EntryPoint = "csmGetDrawableDrawOrders")]
	...
	/// <param name="model">Model to query.</param>
	/// <returns>Valid pointer on success; '0'otherwise.</returns>
	[LibraryImport(Live2DCubismCoreDll, EntryPoint = "csmGetDrawableRenderOrders")]
	...
	/// <param name="model">Model to query.</param>
	/// <returns>Valid pointer on success; '0' otherwise.</returns>
	[LibraryImport(Live2DCubismCoreDll, EntryPoint = "csmGetDrawableOpacities")]
	...
	/// <param name="model">Model to query.</param>
	/// <returns>Valid pointer on success; '0' otherwise.</returns>
	[LibraryImport(Live2DCubismCoreDll, EntryPoint = "csmGetDrawableMaskCounts")]
	...
	/// <param name="model">Model to query.</param>
	/// <returns>Valid pointer on success; '0' otherwise.</returns>
	[LibraryImport(Live2DCubismCoreDll, EntryPoint = "csmGetDrawableMasks")]
	...
	/// <param name="model">Model to query.</param>
	/// <returns>Valid pointer on success; '0' otherwise.</returns>
	[LibraryImport(Live2DCubismCoreDll, EntryPoint = "csmGetDrawableVertexCounts")]
	...
	[LibraryImport(Live2DCubismCoreDll, EntryPoint = "csmGetDrawableVertexPositions")]
	...
	/// <param name="model">Model to query.</param>
	/// <returns>Valid pointer on success; '0' otherwise.</returns>
	[LibraryImport(Live2DCubismCoreDll, EntryPoint = "csmGetDrawableVertexUvs")]
	...
	/// <param name="model">Model to query.</param>
	/// <returns>Valid pointer on success; '0' otherwise.</returns>
	[LibraryImport(Live2DCubismCoreDll, EntryPoint = "csmGetDrawableIndexCounts")]
	...
	/// <param name="model">Model to query.</param>
	/// <returns>Valid pointer on success; '0' otherwise.</returns>
	[LibraryImport(Live2DCubismCoreDll, EntryPoint = "csmGetDrawableIndices")]
	...
	/// <param name="model">Model to query.</param>
	/// <returns>Valid pointer on success; '0' otherwise.</returns>
	[LibraryImport(Live2DCubismCoreDll, EntryPoint = "csmGetDrawableMultiplyColors")]
	...
	/// <param name="model">Model to query.</param>
	/// <returns>Valid pointer on success; '0' otherwise.</returns>
	[LibraryImport(Live2DCubismCoreDll, EntryPoint = "csmGetDrawableScreenColors")]
	...
	/// <param name="model">Model to query.</param>
	/// <returns>Valid pointer on success; '0' otherwise.</returns>
	[LibraryImport(Live2DCubismCoreDll, EntryPoint = "csmGetDrawableParentPartIndices")]
	...
	[LibraryImport(Live2DCubismCoreDll, EntryPoint = "csmResetDrawableDynamicFlags")]
